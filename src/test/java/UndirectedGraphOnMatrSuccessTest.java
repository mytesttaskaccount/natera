...
import com.company.UndirectedGraphOnMatr;
...
public class UndirectedGraphOnMatrSuccessTest {
    private UndirectedGraphOnMatr<MyVertex> g;
    private MyVertex[] v;
